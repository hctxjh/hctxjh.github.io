...
<iframe src="xyft.php" width="100%" height="180" frameborder="0" scrolling="no"></iframe>
  <div class="ad">
    <?php echo $ad?>
  </div>
<table border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><a href="/xyft_index.php"><img src="images/xyft-gj.png" width="140" height="64" alt="冠军" /></a></td>

  </tr>	
</table>
<div id="plandt">正在更新幸运飞艇计划，请稍后...</div>
...
<script language="javascript" type="text/javascript">
	function plancont()
	{
		...
		var htmlobj=$.ajax({url:"ssc_jh.php?ac=xyft-plan",async:false});
