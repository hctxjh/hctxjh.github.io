...
<iframe src="txff.php" width="100%" height="180" frameborder="0" scrolling="no"></iframe>
  <div class="ad">
    <?php echo $ad?>
  </div>
<table border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><a href="/txff_index.php"><img src="images/gwjh.png" width="140" height="64" alt="定位胆个位计划" /></a></td>
    <td><a href="/txff_h2zx_index.php"><img src="images/h2zx.png" width="164" height="64" alt="后二直选" /></a></td>
    <td><a href="/txff_h3zx_index.php"><img src="images/h3zx.png" width="167" height="64" alt="后三直选" /></a></td>
    <td><a href="/txff_h3z6_index.php"><img src="images/h2z6.png" alt="后三组六" width="167" height="64" border="0" /></a></td>	
  </tr>
</table>
...
<script language="javascript" type="text/javascript">
    function plancont()
    {
        ...
        var htmlobj=$.ajax({url:"txff_jh.php?ac=txff-h3z6",async:false});
